...
public class CommentServiceImpl implements CommentService {
    ...
    @Override
    public ApiResponseDto postReComment(Comment parentComment, CommentRequestDto commentRequestDto) {
        Comment comment = new Comment(commentRequestDto.getContent());
    ...
    public List<CommentResponseDto> getComments() {
        return commentRepository.findByParentCommentIsNullOrderByCreatedAtDesc().stream().map(CommentResponseDto::new).toList();
    }
}
